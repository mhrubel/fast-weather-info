...
Tags: weather, forecast, shortcode, widget, email alerts, caching, responsive, sunrise/sunset

== Description ==

The **Fast Weather Info** plugin allows WordPress users to easily display weather information on their site using a widget or shortcode. It supports multiple weather providers and customizable options such as location, forecast days, and data types (e.g., current weather, forecast, or sunrise/sunset times). 

With built-in caching for optimized performance and flexible display settings, it ensures that visitors always receive up-to-date weather information efficiently.

**Key features** include easy-to-use settings, support for different temperature units, and integration with major weather APIs like Visual Crossing.

== Key Features ==

* Multiple Weather Providers: Choose from different weather providers, starting with Visual Crossing, for accurate forecasts and real-time weather.
...
* Forecast Display: Display weather forecasts for up to 15 days.
...
Or, use the shortcode without any parameters, which will pull from the default admin settings:
...
You can use the **Weather Info** widget by selecting it from the block or classic widget options. Configure it according to the settings provided in the widget interface.
...
This plugin is licensed under the GPLv2 or later. Full license text: https://www.gnu.org/licenses/gpl-2.0.html
